...
import StatsIllustrationSrc from "images/logo-full.png";
...
const Subheading = tw(SubheadingBase)`text-center md:text-left text-orange-100`;
const Heading = tw(
  SectionHeading
)`mt-4 font-black text-left text-3xl sm:text-4xl lg:text-5xl text-center md:text-left leading-tight text-blue-100`;
